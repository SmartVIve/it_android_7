...
public class ClipView extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //path.addRect(new RectF(circleCenterPX-radius, circleCenterPY-radius,circleCenterPX+radius , circleCenterPY+radius),Path.Direction.CCW);
        ...
        //canvas.clipRect(circleCenterPX-radius, circleCenterPY-radius,circleCenterPX+radius , circleCenterPY+radius, Region.Op.XOR);
        ...
        //canvas.drawRect(new RectF(circleCenterPX-radius, circleCenterPY-radius,circleCenterPX+radius , circleCenterPY+radius),borderPaint);
