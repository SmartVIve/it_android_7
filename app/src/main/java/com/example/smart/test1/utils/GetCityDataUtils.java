...
public class GetCityDataUtils {
    ...
    public void initOptionData(Context context) {
        /**
    ...
    public ArrayList<JsonBean> getOptions1Items(Context context) {
        if (options1Items.size()==0){
            initOptionData(context);
        }

        return options1Items;
    }

    public ArrayList<ArrayList<String>> getOptions2Items(Context context) {
